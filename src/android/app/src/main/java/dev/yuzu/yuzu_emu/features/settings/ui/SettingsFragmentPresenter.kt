...
package dev.yuzu.yuzu_emu.features.settings.ui

import android.annotation.SuppressLint
import android.os.Build
import android.widget.Toast
import dev.yuzu.yuzu_emu.NativeLibrary
import dev.yuzu.yuzu_emu.R
import dev.yuzu.yuzu_emu.YuzuApplication
import dev.yuzu.yuzu_emu.features.input.NativeInput
import dev.yuzu.yuzu_emu.features.input.model.AnalogDirection
import dev.yuzu.yuzu_emu.features.input.model.NativeAnalog
import dev.yuzu.yuzu_emu.features.input.model.NativeButton
import dev.yuzu.yuzu_emu.features.input.model.NpadStyleIndex
import dev.yuzu.yuzu_emu.features.settings.model.AbstractBooleanSetting
import dev.yuzu.yuzu_emu.features.settings.model.AbstractIntSetting
import dev.yuzu.yuzu_emu.features.settings.model.BooleanSetting
import dev.yuzu.yuzu_emu.features.settings.model.ByteSetting
import dev.yuzu.yuzu_emu.features.settings.model.IntSetting
import dev.yuzu.yuzu_emu.features.settings.model.LongSetting
import dev.yuzu.yuzu_emu.features.settings.model.Settings
import dev.yuzu.yuzu_emu.features.settings.model.Settings.MenuTag
import dev.yuzu.yuzu_emu.features.settings.model.ShortSetting
import dev.yuzu.yuzu_emu.features.settings.model.StringSetting
import dev.yuzu.yuzu_emu.features.settings.model.view.*
import dev.yuzu.yuzu_emu.utils.InputHandler
