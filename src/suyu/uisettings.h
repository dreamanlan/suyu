...
const std::array<Shortcut, 29> default_hotkeys{{
    ...
    {QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Run Data Analyst Script")).toStdString(),                QStringLiteral(QT_TRANSLATE_NOOP("Hotkeys", "Main Window")).toStdString(), {std::string("Ctrl+D"),  std::string(""), Qt::WidgetWithChildrenShortcut, false}},
