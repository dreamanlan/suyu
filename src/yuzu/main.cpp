...
#include "yuzu/debugger/data_analyst.h"
    ...
    if (Loader::AppLoader_NRO::IdentifyType(
        ...
        if (!ContentManager::AreKeysPresent()) {
            QMessageBox::warning(
                ...
                tr("In order to use yuzu you need to provide your own encryption keys. "
    ...
    if (result == Core::SystemResultStatus::Success &&
        ...
        QMessageBox::warning(
            ...
            tr("You are using the deconstructed ROM directory format for this game, which is an "
               ...
               "href='https://yuzu.dev/wiki/overview-of-switch-game-formats'>check out our "
        ...
        case Core::SystemResultStatus::ErrorVideoCore:
            QMessageBox::critical(
                ...
                tr("yuzu has encountered an error while running the video core. "
                   ...
                   "<a href='https://yuzu.dev/help/reference/log-files/'>"
        ...
        default:
            if (result > Core::SystemResultStatus::ErrorLoader) {
                ...
                const auto description =
                    tr("%1<br>Please follow <a href='https://yuzu.dev/help/quickstart/'>the "
                       "yuzu quickstart guide</a> to redump your files.<br>You can refer "
                       "to the yuzu wiki</a> or the yuzu Chat</a> for help.",
...
void GMainWindow::OnGameListNavigateToGamedbEntry(u64 program_id,
    ...
    QDesktopServices::openUrl(QUrl(QStringLiteral("https://yuzu.dev/game/") + directory));
}
...
void GMainWindow::OnOpenModsPage() {
    OpenURL(QUrl(QStringLiteral("https://gitlab.com/yuzu-emu/yuzu/wiki/Switch-Mods")));
}

void GMainWindow::OnOpenQuickstartGuide() {
    OpenURL(QUrl(QStringLiteral("https://yuzu.dev/help/quickstart/")));
}

void GMainWindow::OnOpenFAQ() {
    OpenURL(QUrl(QStringLiteral("https://yuzu.dev/wiki/faq/")));
}
...
int main(int argc, char* argv[]) {
    ...
    // suffix.
    QGuiApplication::setDesktopFileName(QStringLiteral("dev.yuzu_emu.yuzu"));
#endif
